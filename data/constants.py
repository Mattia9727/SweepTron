...
grafici_dir = os.path.join(data_folder, constants["grafici_dir"])
logs_dir = os.path.join(data_folder, constants["logs_dir"])
measures_dir = os.path.join(data_folder, constants["measures_dir"])
iq_measures_dir = os.path.join(data_folder, constants["iq_measures_dir"])
...
af_keysight = os.path.join(data_folder, constants["af_keysight"])
